...
create schema newHyberMarket;
set search_path to newHyberMarket;


CREATE TABLE Employee(																		/*check*/
...
employee_working_hours float  NOT NULL,
employee_department varchar(50)  NOT NULL,
employee_bonus float  NOT NULL,
employee_deduction float  NOT NULL,
gender  VARCHAR(50) NOT NULL      check (gender = 'female' or gender='male' or gender = 'Prefer not to say'),  
PRIMARY KEY (employee_id)
);

create table Sadmin(														/*check*/
Sadmin_id varchar (20) Not Null,
Sadmin_name varchar (20) Not Null,
Sadmin_age varchar (20) Not Null,
Sadmin_gender  VARCHAR(50) NOT NULL      check (Sadmin_gender = 'female' or Sadmin_gender='male'),  
...
category_id varchar(6)  NOT NULL,
/*offer_id  varchar(50) NOT NULL,*/
store_block int NOT NULL,
inventory_block int NOT NULL,
...
INSERT into Employee values('EMP1001','Mahesh Jha','72015478','1978-05-01','mahesh.jha@gmail.com','R.K.Puram','giza','male',1000);
INSERT into Employee values('EMP1002','Sunil Kumar','78621365','1979-01-02','sunilkumar@gmail.com','Rohini','giza','male',20000);
INSERT into Employee values('EMP1003','Niranjan Choudary','83473419','1995-02-13','nkc696@gmail.com','Kailash Nagar','giza','male',3000);
INSERT into Employee values('EMP2001','Shashi Kapoor','98751235','1986-05-07','shashi.kap@gmail.com','Pritampura','giza','male',3000);
INSERT into Employee values('EMP2002','Anjana Singh','87465354','1975-05-06','anjana0605@gmail.com','Rohini','giza','female',2000);
INSERT into Employee values('EMP2003','Degangna Suryavanshi','85219932','1990-02-14','surya.deganga@hotmail.com','Hauz Khas','giza','female',5000);
INSERT into Employee values('EMP2004','Mahima Arora','94620856','1993-01-15','mahima.arora93@gmail.com','Pragati Maidan','giza','female',2000);
INSERT into Employee values('EMP1004','Pragya Richa','84561732','1991-05-05','richa.pragya@hotmail.com','R.K.Puram','giza','female',3000);
INSERT into Employee values('EMP2005','Siddharth Shrivastav','85473215','1990-06-09','sid.shri@gmail.com','Pragati Maidan','giza','male',2000);
INSERT into Employee values('EMP1005','Akash Agarwal','78954635','1987-05-07','coolhunk@gmail.com','Kailash Nagar','giza','male',1000);
INSERT into Employee values('EMP2006','Yash Kumar','84652179','1988-08-15','yash.singh@gmail.com','Dwarka','giza','male',3000);
INSERT into Employee values('EMP1006','Rimmi Sinha','78958978','1985-11-09','rimi.babes@gmail.com','Rohini','ciro','female',4000);
INSERT into Employee values('EMP1007','Kajal Kumari','89547231','1987-05-07','kajalk@gmail.com','Alaknanda','ciro','female',4000);
INSERT into Employee values('EMP1010','Abhishek Sharma','94785123','1975-11-25','coolabhi@gmail.com','Defence Colony','ciro','male',3000);
INSERT into Employee values('EMP1009','Rajat Kapoor','84569254','1984-08-04','rajatkapoor@gmail.com','Janakpuri','ciro','male',2000);
INSERT into Employee values('EMP1008','Saurav Singh','95462154','1987-05-06','sauravsingh56@gmail.com','Karol Bagh','ciro','male',3000);
...
INSERT into inventory values('WARA001','AWARE');
INSERT into inventory values('WARA002','BWAR');
INSERT into inventory values('WARA003','CWAR');
INSERT into inventory values('WARB001','DWAR');
INSERT into inventory values('WARB002','EWAR');
INSERT into inventory values('WARC001','FWAR');
INSERT into inventory values('WARC002','GWAR');
INSERT into inventory values('WARC003','HWAR');
...
INSERT into InvoiceDetails values('AAA001','5000.223','2017-04-01','EMP2001');
INSERT into InvoiceDetails values('AAA002','455000.11','2017-04-01','EMP2003');
INSERT into InvoiceDetails values('AAA003','9865.22','2017-04-01','EMP2004');
INSERT into InvoiceDetails values('AAB001','8000.25','2015-03-05','EMP2002');
INSERT into InvoiceDetails values('AAB002','56666.22','2014-03-05','EMP2005');
INSERT into InvoiceDetails values('AAH001','7889.42','2014-02-15','EMP2006');
INSERT into InvoiceDetails values('AAC001','9999.88','2017-02-15','EMP2005');
INSERT into InvoiceDetails values('AAC002','7852.88','2017-02-15','EMP2005');
INSERT into InvoiceDetails values('AAD001','400.88','2017-01-15','EMP2002');
INSERT into InvoiceDetails values('AAD002','52224.88','2017-01-15','EMP2001');
INSERT into InvoiceDetails values('AAD003','6655.88','2017-01-15','EMP2004');
INSERT into InvoiceDetails values('AAE001','488.88','2016-12-30','EMP2003');
INSERT into InvoiceDetails values('AAE002','300.88','2016-12-30','EMP2002');
INSERT into InvoiceDetails values('AAF001','400.88','2015-01-15','EMP2002');
INSERT into InvoiceDetails values('AAF002','52224.88','2015-01-15','EMP2001');
INSERT into InvoiceDetails values('AAG003','6655.88','2016-01-15','EMP2004');
INSERT into InvoiceDetails values('AAG001','488.88','2016-03-30','EMP2003');
INSERT into InvoiceDetails values('AAG002','3000.88','2016-04-30','EMP2002');

INSERT into InvoiceDetails values('AAI001','6000.223','2017-05-01','EMP2001');
INSERT into InvoiceDetails values('AAI002','495000.11','2017-04-29','EMP2003');
INSERT into InvoiceDetails values('AAJ003','19865.22','2017-04-12','EMP2004');
INSERT into InvoiceDetails values('AAJ001','800.25','2015-02-05','EMP2002');
INSERT into InvoiceDetails values('AAJ002','5666.22','2014-07-07','EMP2005');
INSERT into InvoiceDetails values('AAK001','78289.42','2014-02-12','EMP2006');
INSERT into InvoiceDetails values('AAK002','999.88','2016-06-15','EMP2005');
INSERT into InvoiceDetails values('AAK003','4000.88','2017-01-15','EMP2006');
INSERT into InvoiceDetails values('AAL002','23224.88','2016-02-15','EMP2001');
INSERT into InvoiceDetails values('AAL003','6655.88','2017-01-12','EMP2004');
INSERT into InvoiceDetails values('AAM001','4880.88','2016-11-30','EMP2001');
INSERT into InvoiceDetails values('AAM002','300.88','2016-11-30','EMP2002');
INSERT into InvoiceDetails values('AAN001','40030.88','2015-07-15','EMP2002');
INSERT into InvoiceDetails values('AAN002','5222.88','2014-01-15','EMP2001');
INSERT into InvoiceDetails values('AAN003','66555.88','2016-01-15','EMP2004');
INSERT into InvoiceDetails values('AAP001','4880.88','2015-04-30','EMP2003');
INSERT into InvoiceDetails values('AAP002' ,'300.88','2016-04-28','EMP2002');
